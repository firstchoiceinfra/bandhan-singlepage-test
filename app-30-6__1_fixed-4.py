    ...
    if accepted:
        ...
        if not st.session_state.vcall_active:
            ...
            if app_id and agora_token:
                ...
                st.warning("\u26A0\uFE0F Video calling isn't fully set up yet — add AGORA_APP_ID and AGORA_APP_CERTIFICATE in Secrets, and make sure the `agora-token-builder` package is listed in requirements.txt.")
