...
def render_tnc_gate(gate_key, heading, subtext):
    ...
    NOTE: acceptance is stored in session_state only, since there's no
    database yet — it resets on browser refresh/new session. Once a real
    database is connected, this should also save acceptance + a timestamp
    permanently against the user's account for real legal proof of consent."""
