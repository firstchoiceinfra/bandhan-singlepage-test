...
nothing was skipped from these 28 pages, they're 1:1 with the originals.
"""
...
.grievance-box { background: #FFF8E1; border-left: 5px solid #D4AF37; padding: 18px; border-radius: 8px; margin-top: 15px; }""")
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["\U0001F4C4 Terms & Conditions", "\U0001F512 Privacy Policy", "\U0001F4DE Grievance Officer", "\U0001F5D1\uFE0F Delete My Data"])

    with tab1:
        st.markdown("<div class='legal-card'>", unsafe_allow_html=True)
        st.markdown("### Terms & Conditions")
        st.write("By registering on Bandhan, you agree to use the platform only for genuine matrimonial purposes. Misrepresentation of identity, age, marital status, or photographs is strictly prohibited and may lead to permanent account suspension.")
        st.markdown("#### Eligibility")
        st.write("Users must be 21 years (male) / 18 years (female) or above, as per the Prohibition of Child Marriage Act, 2006.")
        st.markdown("#### Membership & Payments")
        st.write("Paid plans (Silver / Gold / Diamond) are non-transferable. Refunds, where applicable, follow our Refund Policy shared at the time of purchase.")
        st.markdown("#### Prohibited Conduct")
        st.write("Harassment, solicitation, spamming, or posting obscene content will result in immediate account termination and may be reported to law enforcement where applicable.")
        st.markdown("</div>", unsafe_allow_html=True)
